...
public class JogosCategory extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<Console> listAdapter = new ArrayAdapter(
                this, android.R.layout.simple_list_item_1, Jogos.jogo);
        listConsole.setAdapter(listAdapter);
    }
    public void onListItemClick(ListView listView, View itemView, int position, long id){
        Intent intent = new Intent(JogosCategory.this, JogosDetalhes.class);
